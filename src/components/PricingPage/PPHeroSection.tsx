...
export default function PPHeroSection() {
  ...
  const SubscriptionCardComponent = ({
    ...
    return (
      ...
      >
        <div className="bg-white dark:bg-gray-900 w-full h-full p-8 xl:p-10 rounded-3xl rounded-b-none flex-1">
          {tier.mostPopular ? (
            <p className="rounded-full absolute bg-indigo-600/10 dark:bg-indigo-400/10 py-1 text-xs/5 mb-0 right-5 px-2 top-5 max-w-24 text-center font-semibold text-indigo-600 dark:text-indigo-400">
              Most popular
            </p>
          ) : null}
          <div className="flex flex-col gap-y-4 items-center justify-between">
            ...
            <p className="mt-0 -translate-y-2 text-gray-600 dark:text-gray-400">{`Billed ${
                  ...
                  <ul className="my-0 space-y-2 list-none px-0">
                    {section.content.map((item, itemIndex) => (
                      ...
                      >
                        ...
                        <p className="font-sans font-normal text-base my-0 leading-6 text-mf-stack-gray-light dark:text-gray-400">
                          {item}
                        </p>
                      </li>
                    ))}
        ...
        <div className="bg-mf-stack-gray-primary dark:bg-gray-800 p-8 xl:p-10 rounded-3xl rounded-t-none border border-solid border-gray-300 dark:border-gray-600 border-b-0 border-x-0">
          <a
            href={tier.href}
            aria-describedby={tier.id}
            className="bg-mf-stack-blue-dark text-white shadow-sm hover:bg-mf-stack-blue hover:text-white block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:focus-visible:outline-indigo-400"
          >
            Get Started
          </a>
        </div>
  ...
  return (
    <div className="bg-pricing-page-bg bg-no-repeat bg-[top_30rem_center] lg:bg-center bg-contain w-full">
      <div className=" py-20 sm:pt-[98px]  mx-auto max-w-7xl px-6 lg:px-8">
        <div className=" ">
          ...
          <div className="mt-8 lg:mt-16 flex justify-center space-x-3">
            <Switch
             ...
             data-[checked]:bg-mf-stack-blue-dark dark:data-[checked]:bg-[#151357] dark:data-[checked]:border-solid  dark:data-[checked]:border-gray-800 
             border-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 
             duration-300"
            >
              <span
                className="size-4 -translate-x-0.5 rounded-full bg-white dark:bg-gray-300  
               transition group-data-[checked]:translate-x-4 duration-300"
              />
            </Switch>
