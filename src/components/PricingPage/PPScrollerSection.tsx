...
import CustomStickyScroller from "../Common/CustomStickyScroller";

import { ArrowRightIcon } from "@heroicons/react/24/outline";

export const PPScrollerSection = () => {
  // Data Content for Previous Scroller Component
  // const dataContent = [
  //   {
  //     title: "Billing",
  //     description:
  ...
  // Data Content for the New Scroller Component
  const dataContent = {
    scrollingContent: [
      {
        title: "Billing",
  ...
  return (
    <div className="mx-auto  max-w-7xl  py-4 px-6 lg:px-8 flex flex-col lg:gap-y-8 items-start">
      {/* Previous Scroller Component with separate sticky images for each section */}
