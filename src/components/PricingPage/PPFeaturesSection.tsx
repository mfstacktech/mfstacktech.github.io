    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <h2 className="text-4xl mt-3 mb-0 font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
            Beautiful analytics to grow smarter
          </h2>
          <p className="mt-5 mb-0 text-lg/8 leading-7 text-gray-600">
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                ...
                <div className="mt-5 flex flex-auto flex-col text-base/7 text-gray-600">
                  <p className="font-sans text-xl font-semibold text-black my-0">
                    {feature.name}
                  </p>
